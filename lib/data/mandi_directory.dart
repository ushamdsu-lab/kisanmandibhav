...
class MandiDirectory {
  ...
  static const Map<String, List<String>> rajasthanMandis = {
    ...
    'Jodhpur': ['Jodhpur (Grain) APMC', 'Jodhpur (F&V) APMC', 'Phalodi APMC', 'Pipar City APMC', 'Bilara APMC', 'Mathania APMC', 'Bhopalgarh APMC', 'Osian APMC', 'Balesar APMC'],
    'Phalodi': ['Phalodi APMC', 'Baap APMC', 'Lohawat APMC'],
    'Balotra': ['Balotra APMC', 'Siwana APMC', 'Jasol APMC'],
    'Beawar': ['Beawar APMC', 'Jaitaran APMC', 'Bijainagar APMC'],
    'Didwana-Kuchaman': ['Didwana APMC', 'Kuchaman City APMC', 'Makrana APMC', 'Ladnun APMC', 'Parbatsar APMC', 'Degana APMC'],
    'Karauli': ['Karauli APMC', 'Hindaun City APMC', 'Todabhim APMC'],
    'Kota': ['Kota APMC', 'Kota (F&V) APMC', 'Ramganjmandi APMC', 'Sangod APMC', 'Itawa APMC', 'Sultanpur APMC'],
    ...
    'Pali': ['Pali APMC', 'Sojat Road APMC', 'Sojat City APMC', 'Jaitaran APMC', 'Sumerpur APMC', 'Falna APMC', 'Bali APMC', 'Rani APMC'],
