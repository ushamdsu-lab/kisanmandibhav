...
class CityDatabase {
  static const List<CityLocation> popularCities = [
    ...
    CityLocation(name: 'मथानिया (Mathania)', state: 'Rajasthan', district: 'Jodhpur', mandi: 'Jodhpur (Grain) APMC', latitude: 26.5312, longitude: 73.0232, icon: '🌶️'),
    ...
    CityLocation(name: 'ओसियां (Osian)', state: 'Rajasthan', district: 'Jodhpur', mandi: 'Jodhpur (Grain) APMC', latitude: 26.7262, longitude: 72.9069, icon: '🛕'),
    ...
    CityLocation(name: 'भोपालगढ़ (Bhopalgarh)', state: 'Rajasthan', district: 'Jodhpur', mandi: 'Pipar City APMC', latitude: 26.6500, longitude: 73.4500, icon: '🌾'),
    CityLocation(name: 'बालेसर (Balesar)', state: 'Rajasthan', district: 'Jodhpur', mandi: 'Jodhpur (Grain) APMC', latitude: 26.4000, longitude: 72.4500, icon: '🌾'),
    CityLocation(name: 'लूणी (Luni)', state: 'Rajasthan', district: 'Jodhpur', mandi: 'Jodhpur (Grain) APMC', latitude: 26.0400, longitude: 73.0800, icon: '🌾'),
